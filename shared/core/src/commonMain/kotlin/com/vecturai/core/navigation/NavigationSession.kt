...
data class NavigationSession(
    ...
    val durationSeconds: Long?
        get() {
            if (endedAtIso == null || startedAtIso.isEmpty()) return null
            // Simple ISO parsing for display — both are ISO-8601 strings
            return null // Computed at UI layer from timestamps
        }
}
