...
- Adds Android runtime libraries required by the Compose/ARCore flow: lifecycle runtime compose, coroutines Android, Kotlinx Serialization JSON, ML Kit barcode scanning, and ARCore.
